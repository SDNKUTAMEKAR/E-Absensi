				...
				<div class="content-top-grids">
					...
					<div class="col-md-4 contact-right">
						<div class="contact-right-top">
							<div class="contact-right-middle-heading " >
								<h3><img src="images/logokarawang.png" width="70%" alt="Image"></h3>
							</div>
						...
						<div class="contact-right-middle">
							...
							<div class="login-info">
								...
								</a><a href="index"> Kembali ke Beranda</a>
					...
					<div class="col-md-4 content-right">
						<div class="clock-grids">
							...
							<div class="clock-bottom">
								<div class="clock">
									<marquee scrollamount="5"><b style="color:white" >Selamat Datang di SDN KUTAMEKAR 1</b></marquee>
